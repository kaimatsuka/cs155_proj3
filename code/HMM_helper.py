...
def isDigitOnly(line):
    ''' 
    Given a line of string, determine whether the line contains DIGITS or SPACE
    characters only. Used to find the title of the poem.
    '''
    return all(var.isdigit() for var in line.split())
